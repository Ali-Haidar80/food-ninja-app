    ...
    .onEnd((event) => {
      if (translateY.value > -MAX_HEIGHT / 1.6) {
        ...
        translateY.value = withTiming(
          Math.max(translateY.value, -MAX_HEIGHT + 80)
        );
      }
    ...
    <View style={{ flex: 1, backgroundColor: "0d0d0d" }}>
      <GestureHandlerRootView style={{ flex: 1 }}>
        <View style={{ width: "100%", height: MAX_HEIGHT / 2 }}>
          <Image
            style={{ width: "100%", height: MAX_HEIGHT / 2 }}
            source={require("./../Images/menuItems/cake.jpg")}
          />
        </View>
          ...
          <Animated.View style={[styles.DragableContainer, rstyle]}>
            ...
            <View style={styles.DataContainer}>
              ...
              >
                ...
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  <Image source={require("./../Images/shopbag.png")} />
                  <Text
                    style={{
                      color: "rgba(100,100,100,0.7)",
                      fontSize: 18,
              ...
              >
                <IconE size={5} color={"white"} name="circle" />
                <Text
                  style={{
                    fontSize: 14,
                    marginLeft: 5,
              ...
              >
                ...
                <View style={{}}>
                  ...
                  >
                    ...
                    >
                      This Is great, So delicious! You Must Here, With Your
                      family . .{" "}
                    </Text>
                  </View>
                </View>
      ...
      <View style={{position:"absolute",bottom:0,marginTop:500}}>
        <FullGbutton name="Add To Cart" />
      </View>
    </View>
  );
};
